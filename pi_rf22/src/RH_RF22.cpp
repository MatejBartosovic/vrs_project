...
RH_RF22::RH_RF22( uint8_t interruptPin, GenericSPI& spi)
    :
    RHSPIDriver(spi)
{
...
bool RH_RF22::init()
{
    ...
    if(wiringPiSetupGpio()==-1);
    	printf("wiring pi init failed");
    //wiringPiISR(_interruptPin,INT_EDGE_FALLING,&handleInterrupt);
...
bool RH_RF22::setModemConfig(ModemConfigChoice index)
{
    ...
    memcpy(&cfg, &MODEM_CONFIG_TABLE[index], sizeof(RH_RF22::ModemConfig));
